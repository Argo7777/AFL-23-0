...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/supercoach/`, changeFrequency: "daily", priority: 0.7 },
    { url: `${base}/supercoach/players/`, changeFrequency: "daily", priority: 0.6 },
    { url: `${base}/supercoach/prices/`, changeFrequency: "daily", priority: 0.6 },
    { url: `${base}/supercoach/value/`, changeFrequency: "daily", priority: 0.6 },
    { url: `${base}/supercoach/form/`, changeFrequency: "daily", priority: 0.6 },
