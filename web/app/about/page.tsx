...
const sections: { h: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      "You hand-picked legends — so does the opposition. Every week of your simulated season you face a synthetic all-star side: a random handful drawn from a random selected decade's very best players (the top 50 for five-a-side modes, the top 100 for full squads). Your team rating and theirs both map onto the real historical strength scale — built from every actual club season since 1897 — and each game is decided by head-to-head probability. 10,000 seasons are simulated; the record you see is the most common outcome, and week-to-week opponent quality swings make every season genuinely different.",
      "No side, however stacked, escapes the chance of an upset: injuries, weather and freak days are part of the sport. Against opposition of this calibre, even the greatest team ever assembled almost never gets through untouched — 23-0 is meant to be the stuff of legend. (The Wooden Spoon chase still plays history's real clubs — you can't tank against all-stars.)",
      "A winning record books a finals berth — then September becomes its own game. You play four cut-throat finals one at a time against the era's best, and the premiership is deliberately as rare as perfection itself: even the greatest side ever assembled wins the flag only about one campaign in twenty. In the full-squad modes, finals also bring live injuries — older players break down more often, stretchered stars must be covered from your bench, and one emergency spin per campaign is all the league will grant you.",
    ],
  },
];
