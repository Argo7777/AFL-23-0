...
const sections: { h: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Two rules keep perfection honest. The schedule skips the bottom quartile of history's teams and leans toward quality — no fixture is 23 games against wooden-spooners. And no side, however stacked, wins a game of footy more than 94% of the time: injuries, weather and freak days are part of the sport. Even a flawless all-legend team runs the table only about one season in four — 23-0 is meant to be legendary.",
